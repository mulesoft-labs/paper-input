...
declare namespace Polymer {
   ...
   */
  function PaperInputBehavior<T extends new (...args: any[]) => {}>(base: T): T & PaperInputBehaviorConstructor & Polymer.IronControlStateConstructor & Polymer.IronA11yKeysBehaviorConstructor;

  interface PaperInputBehaviorConstructor {
    new(...args: any[]): PaperInputBehavior;
  }

  interface PaperInputBehavior {
     ...
     */
    hasValidationMessage: boolean|null|undefined;
    ...
    _validationStatesChanged(validationStates: any): void;
    _computeValidityStatus(invalid: any, errorMessage: any): void;
